...
export function useMarkdownRender(markdown: string, basePath?: string): MarkdownRenderResult {
          ...
          const options: HTMLReactParserOptions = {
            replace(domNode: DOMNode) {
              if (domNode instanceof Element && domNode.name === 'img') {
                ...
                let imageSrc = src;
                if (basePath && src && !src.startsWith('/') && !src.startsWith('http')) {
              ...
              if (
                domNode.type === 'text' &&
                domNode.data &&
                domNode.data.includes('__CODE_BLOCK_')
              ) {
